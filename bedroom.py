    ...
    class Hero:
        ...
        def interaction(self, x, y, cuboc_counter):
            ...
            if sx == -2 and sy == 4:
                ...
                box_c.image = load_image('box-c.png', (0, 0, 100))
                box_c.image = pygame.transform.scale(box_c.image, (150, 120))
                all_sprites.add(lom)
                self.lomm = True
                self.kn = False
                return cuboc_counter + 1
            ...
            for event in pygame.event.get():
                ...
                if keys[pygame.K_w]:
                    ...
                    if event.key == pygame.K_e:
                        cuboc_counter = hero.interaction(sprite.rect[0], sprite.rect[1], cuboc_counter)
                else:
                    hero.drawing()
